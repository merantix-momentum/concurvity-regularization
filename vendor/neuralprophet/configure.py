...
from vendor.neuralprophet import df_utils, np_types, utils, utils_torch
from vendor.neuralprophet.custom_loss_metrics import PinballLoss
...
class Train:
    ...
    loss_func: torch.nn.modules.loss._Loss  # Union[str, torch.nn.modules.loss._Loss, Callable]
    ...
    concurvity_reg_lambda: float = 0.0
